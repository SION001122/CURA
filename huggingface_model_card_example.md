...
> ⚠️ **This is an example template for CURA-based models intended for sharing on Hugging Face.**  
> ⚠️ **Replace `CURAv1_MODEL_NAME` with your actual model name.**  
> ⚠️ **Do not upload this file as-is without updating it for your own model.**
